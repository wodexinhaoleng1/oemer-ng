...
class GGMLExporter:
    ...
    @staticmethod
    def write_tensor(f, name: str, tensor: torch.Tensor, data_type: int = GGML_TYPE_F32):
        """
    ...
    def export(
        self, output_path: str, use_fp16: bool = False, metadata: Optional[Dict[str, Any]] = None
    ):
        """
    ...
    @staticmethod
    def export_quantized(model: nn.Module, output_path: str, quantization_bits: int = 8):
        """
        ...
        print(
            f"Note: Using FP16 export. Full {quantization_bits}-bit quantization "
...
def convert_model_for_deployment(
    model: nn.Module, output_dir: str, formats: list = ["ggml", "onnx"], use_fp16: bool = True
):
    """
